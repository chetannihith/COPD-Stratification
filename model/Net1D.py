...
class BasicStage(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, ratio, kernel_size, stride, groups, i_stage, m_blocks, use_bn=False,
...
class Net1D(nn.Module):
    ...
    def __init__(self, in_channels, base_filters, ratio, filter_list, m_blocks_list, kernel_size, stride, groups_width,
                 n_classes=2, use_bn=False, use_do=True, verbose=False):
